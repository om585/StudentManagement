...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/studentTimeTable.css">
<div class="main-content">

<h2 style="text-align:center;">My Time Table</h2>
...
<% if ("BCA".equalsIgnoreCase(dept)) { %>
    ...
    <% if ("FY".equalsIgnoreCase(cls)) { %>

        <h3>BCA - FY</h3>
        <table border="1" width="100%">
            <tr><th>Day</th><th>9-10</th><th>10-11</th><th>11-12</th><th>12-1</th><th>2-3</th></tr>
    ...
    <% } else if ("SY".equalsIgnoreCase(cls)) { %>
    ...
    <% } else if ("TY".equalsIgnoreCase(cls)) { %>
...
<% } else { %>
    ...
    <p style="text-align:center;color:red;">No timetable available</p>
